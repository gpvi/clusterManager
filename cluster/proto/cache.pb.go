...
// file_cache_proto_rawDesc is the original protobuf wire-format descriptor.
// NOTE: the raw bytes retain the original "geecachepb" package name; the Go-level
// package is "proto". Modifying the binary descriptor would corrupt it.
